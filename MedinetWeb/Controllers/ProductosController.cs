...
namespace MedinetWeb.Controllers
{
    ...
    public class ProductosController : Controller
    {
        ...
        public ActionResult GetAll([DataSourceRequest] DataSourceRequest request)
        {
            ...
            var lista = _database.Productos.GetAll();  //_database.Registers.GetAll();
            ...
            return Json(lista.ToDataSourceResult(request, record => new
            {
                record.ID_Producto,
                record.ID_Marca,
                record.TX_IDProductoCliente,
                record.TX_Producto,
                record.TX_ProductoDesc,
                record.BO_Activo
            }));
        }
        ...
        public ActionResult Add([DataSourceRequest] DataSourceRequest request, MW_Productos record)
        {
            // Test if Register object and modelstate is valid.
            if (record != null && ModelState.IsValid)
            {
                // Add Register to UoW.
                _database.Productos.Add(record);
        ...
        [SessionExpireFilter]
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Update([DataSourceRequest] DataSourceRequest request, MW_Productos record)
        {
            // Test if Register object and modelstate is valid.
            if (record != null && ModelState.IsValid)
            {
                // Update Register to UoW.
                _database.Productos.Update(record);
        ...
        [SessionExpireFilter]
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Delete([DataSourceRequest] DataSourceRequest request, MW_Productos record)
        {
            // Test if Register object and modelstate is valid.           
            if (record != null && ModelState.IsValid)
            {
                // Delete Register from UoW.
                _database.Productos.Delete(record);
        ...
        {
            IEnumerable<SelectListItem> listRecord = db.MW_Productos
