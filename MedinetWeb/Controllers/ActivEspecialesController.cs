...
namespace MedinetWeb.Controllers
{
    [Authorize]
    [SessionExpireFilter]
    public class ActivEspecialesController : Controller
    {
        ...
        public ActionResult GetAll([DataSourceRequest] DataSourceRequest request)
        {
            ...
            var lista = _database.ActivEspeciales.GetAll();  //_database.Registers.GetAll();
            ...
            {
                record.ID_ActivEspecial,
                record.TX_ActivEspecial,
                record.ID_Linea,
                record.ID_Marca,
                record.ID_CicloIni,
                record.ID_CicloFin,
        ...
        [Authorize(Roles = "Administrador, Mercadeo")]
        [SessionExpireFilter]
        public ActionResult Add([DataSourceRequest] DataSourceRequest request, MW_ActivEspeciales record)
        {
            // Test if Register object and modelstate is valid.
            if (record != null && ModelState.IsValid)
            {
                // Add Register to UoW.
                _database.ActivEspeciales.Add(record);
        ...
        [Authorize(Roles = "Administrador, Mercadeo")]
        [SessionExpireFilter]
        public ActionResult Update([DataSourceRequest] DataSourceRequest request, MW_ActivEspeciales record)
        {
            // Test if Register object and modelstate is valid.
            if (record != null && ModelState.IsValid)
            {
                // Update Register to UoW.
                _database.ActivEspeciales.Update(record);
        ...
        [Authorize(Roles = "Administrador, Mercadeo")]
        [SessionExpireFilter]
        public ActionResult Delete([DataSourceRequest] DataSourceRequest request, MW_ActivEspeciales record)
        {
            // Test if Register object and modelstate is valid.           
            if (record != null && ModelState.IsValid)
            {
                // Delete Register from UoW.
                _database.ActivEspeciales.Delete(record);
