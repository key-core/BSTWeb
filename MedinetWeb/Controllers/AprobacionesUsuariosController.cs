...
namespace MedinetWeb.Controllers
{
    [Authorize]
    [SessionExpireFilter]
    public class AprobacionesUsuariosController : Controller
    {
        ...
        public ActionResult GetAll([DataSourceRequest] DataSourceRequest request)
        {
            ...
            var lista = _database.AprobacionesUsuarios.GetAll()
                            .OrderByDescending(e => e.ID_Ciclo);  //_database.Registers.GetAll();
