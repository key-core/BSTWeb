...
namespace MedinetWeb.Controllers
{
    [Authorize]
    [SessionExpireFilter]
    public class ConsideracionMedicosController : Controller
    {
        ...
        public ActionResult GetAll([DataSourceRequest] DataSourceRequest request)
        {
            ...
            var lista = _database.ConsideracionMedicos.GetAll();  //_database.Registers.GetAll();
            ...
            {
                record.ID_Consideracion,
                record.TX_Consideracion,
                record.BO_Activo
            }));
        }
        ...
        public ActionResult Add([DataSourceRequest] DataSourceRequest request, MW_ConsideracionMedicos record)
        {
            // Test if Register object and modelstate is valid.
            if (record != null && ModelState.IsValid)
            {
                // Add Register to UoW.
                _database.ConsideracionMedicos.Add(record);
        ...
        [SessionExpireFilter]
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Update([DataSourceRequest] DataSourceRequest request, MW_ConsideracionMedicos record)
        {
            // Test if Register object and modelstate is valid.
            if (record != null && ModelState.IsValid)
            {
                // Update Register to UoW.
                _database.ConsideracionMedicos.Update(record);
        ...
        [SessionExpireFilter]
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Delete([DataSourceRequest] DataSourceRequest request, MW_ConsideracionMedicos record)
        {
            // Test if Register object and modelstate is valid.           
            if (record != null && ModelState.IsValid)
            {
                // Delete Register from UoW.
                _database.ConsideracionMedicos.Delete(record);
