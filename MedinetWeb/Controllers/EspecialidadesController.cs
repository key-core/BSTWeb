...
namespace MedinetWeb.Controllers
{
    ...
    public class EspecialidadesController : Controller
    {
        ...
        public ActionResult GetAll([DataSourceRequest] DataSourceRequest request)
        {
            ...
            var lista = _database.Especialidades.GetAll();  //_database.Registers.GetAll();
            ...
            return Json(lista.ToDataSourceResult(request, record => new
            {
                ...
                record.TX_Especialidad,
                record.TX_EspecialidadAbr,
                record.BO_Activo
            }));
        }
        ...
        public ActionResult Add([DataSourceRequest] DataSourceRequest request, MW_Especialidades record)
        {
            // Test if Register object and modelstate is valid.
            if (record != null && ModelState.IsValid)
            {
                // Add Register to UoW.
                _database.Especialidades.Add(record);
        ...
        [SessionExpireFilter]
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Update([DataSourceRequest] DataSourceRequest request, MW_Especialidades record)
        {
            // Test if Register object and modelstate is valid.
            if (record != null && ModelState.IsValid)
            {
                // Update Register to UoW.
                _database.Especialidades.Update(record);
        ...
        [SessionExpireFilter]
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Delete([DataSourceRequest] DataSourceRequest request, MW_Especialidades record)
        {
            // Test if Register object and modelstate is valid.           
            if (record != null && ModelState.IsValid)
            {
                // Delete Register from UoW.
                _database.Especialidades.Delete(record);
        ...
        {
            IEnumerable<SelectListItem> listRecord = db.MW_Especialidades
                                                        .Where(c => c.BO_Activo == true)
                                                        .AsEnumerable().Select(c => new SelectListItem()
                                                        {
                                                            Text = c.TX_Especialidad,
                                                            Value = c.ID_Especialidad.ToString()
                                                        });
        ...
        [Authorize]
        [SessionExpireFilter]
        public JsonResult GetEspecialidades_EsqPro(Int16 ID_Linea)
        {
            IEnumerable<SelectListItem> listRecord = db.SP_MW_Especialidades_EsqPro(ID_Linea).ToList()
                .Where(c => c.BO_Activo == true)
                .OrderBy(c => c.TX_Especialidad)
                .AsEnumerable().Select(c => new SelectListItem()
                {
                    Text = c.TX_Especialidad,
                    Value = c.ID_Especialidad.ToString()
        ...
        [Authorize]
        [SessionExpireFilter]
        public JsonResult GetEspecialidades_ConDis(string IDsLineas)
        {
            IEnumerable<SelectListItem> listRecord = db.SP_MWS_Especialidades_ConDis(IDsLineas).ToList()
                .Where(c => c.BO_Activo == true)
                .OrderBy(c => c.TX_Especialidad)
                .AsEnumerable().Select(c => new SelectListItem()
                {
