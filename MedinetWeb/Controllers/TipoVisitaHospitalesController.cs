...
namespace MedinetWeb.Controllers
{
    [Authorize]
    [SessionExpireFilter]
    public class TipoVisitaHospitalesController : Controller
    {
        ...
        [Authorize]
        [SessionExpireFilter]
        public JsonResult GetTiposVisitas()
        {
            IEnumerable<SelectListItem> listRecord = db.MW_TipoVisitaHospitales
                                                        .Where(c => c.BO_Activo == true)
                                                        .AsEnumerable().Select(c => new SelectListItem()
                                                        {
                                                            Text = c.TX_TipoVisita,
                                                            Value = c.ID_TipoVisita.ToString()
                                                        });
        ...
        public ActionResult GetAll([DataSourceRequest] DataSourceRequest request)
        {
            ...
            var lista = _database.TipoVisitaHospitales.GetAll();  //_database.Registers.GetAll();
            ...
            {
                record.ID_TipoVisita,
                record.TX_TipoVisita,
                record.BO_Activo
            }));
        }
        ...
        public ActionResult Add([DataSourceRequest] DataSourceRequest request, MW_TipoVisitaHospitales record)
        {
            // Test if Register object and modelstate is valid.
            if (record != null && ModelState.IsValid)
            {
                // Add Register to UoW.
                _database.TipoVisitaHospitales.Add(record);
        ...
        [SessionExpireFilter]
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Update([DataSourceRequest] DataSourceRequest request, MW_TipoVisitaHospitales record)
        {
            // Test if Register object and modelstate is valid.
            if (record != null && ModelState.IsValid)
            {
                // Update Register to UoW.
                _database.TipoVisitaHospitales.Update(record);
        ...
        [SessionExpireFilter]
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Delete([DataSourceRequest] DataSourceRequest request, MW_TipoVisitaHospitales record)
        {
            // Test if Register object and modelstate is valid.           
            if (record != null && ModelState.IsValid)
            {
                // Delete Register from UoW.
                _database.TipoVisitaHospitales.Delete(record);
