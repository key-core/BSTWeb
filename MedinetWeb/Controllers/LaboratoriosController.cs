...
namespace MedinetWeb.Controllers
{
    ...
    public class LaboratoriosController : Controller
    {
        ...
        public ActionResult GetAll([DataSourceRequest] DataSourceRequest request)
        {
            ...
            var lista = _database.Laboratorios.GetAll();  //_database.Registers.GetAll();
            ...
            return Json(lista.ToDataSourceResult(request, record => new
            {
                ...
                record.TX_Laboratorio,
                record.BO_LaboratorioMedinet,
                record.BO_Activo
            }));
        }
        ...
        public ActionResult Add([DataSourceRequest] DataSourceRequest request, MW_Laboratorios record)
        {
            // Test if Register object and modelstate is valid.
            if (record != null && ModelState.IsValid)
            {
                // Add Register to UoW.
                _database.Laboratorios.Add(record);
        ...
        [SessionExpireFilter]
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Update([DataSourceRequest] DataSourceRequest request, MW_Laboratorios record)
        {
            // Test if Register object and modelstate is valid.
            if (record != null && ModelState.IsValid)
            {
                // Update Register to UoW.
                _database.Laboratorios.Update(record);
        ...
        [SessionExpireFilter]
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Delete([DataSourceRequest] DataSourceRequest request, MW_Laboratorios record)
        {
            // Test if Register object and modelstate is valid.           
            if (record != null && ModelState.IsValid)
            {
                // Delete Register from UoW.
                _database.Laboratorios.Delete(record);
        ...
        [Authorize]
        [SessionExpireFilter]
        public JsonResult GetLaboratorios()
        {
            IEnumerable<SelectListItem> listRecord = db.MW_Laboratorios
                                                        .Where(c => c.BO_Activo == true)
                                                        .AsEnumerable().Select(c => new SelectListItem()
                                                        {
                                                            Text = c.TX_Laboratorio,
                                                            Value = c.ID_Laboratorio.ToString()
                                                        });
        ...
        [Authorize]
        [SessionExpireFilter]
        public JsonResult GetLaboratoriosMedinet()
        {
            IEnumerable<SelectListItem> listRecord = db.MW_Laboratorios
                                                        .Where(c => c.BO_Activo == true && c.BO_LaboratorioMedinet == true)
                                                        .AsEnumerable().Select(c => new SelectListItem()
                                                        {
                                                            Text = c.TX_Laboratorio,
                                                            Value = c.ID_Laboratorio.ToString()
