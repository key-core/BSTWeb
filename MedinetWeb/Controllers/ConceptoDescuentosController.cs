...
namespace MedinetWeb.Controllers
{
    [Authorize]
    [SessionExpireFilter]
    public class ConceptoDescuentosController : Controller
    {
        ...
        public ActionResult GetAll([DataSourceRequest] DataSourceRequest request)
        {
            ...
            var lista = _database.ConceptoDescuentos.GetAll();  //_database.Registers.GetAll();
            ...
            return Json(lista.ToDataSourceResult(request, record => new
            {
                ...
                record.TX_ConceptoDescuento,
                record.BO_AplicaCobertura,
                record.BO_AplicaVehiculo,
                record.BO_Activo
            }));
        }
        ...
        public ActionResult Add([DataSourceRequest] DataSourceRequest request, MW_ConceptoDescuentos record)
        {
            // Test if Register object and modelstate is valid.
            if (record != null && ModelState.IsValid)
            {
                // Add Register to UoW.
                _database.ConceptoDescuentos.Add(record);
        ...
        [SessionExpireFilter]
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Update([DataSourceRequest] DataSourceRequest request, MW_ConceptoDescuentos record)
        {
            // Test if Register object and modelstate is valid.
            if (record != null && ModelState.IsValid)
            {
                // Update Register to UoW.
                _database.ConceptoDescuentos.Update(record);
        ...
        [SessionExpireFilter]
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Delete([DataSourceRequest] DataSourceRequest request, MW_ConceptoDescuentos record)
        {
            // Test if Register object and modelstate is valid.           
            if (record != null && ModelState.IsValid)
            {
                // Delete Register from UoW.
                _database.ConceptoDescuentos.Delete(record);
        ...
        [Authorize]
        [SessionExpireFilter]
        public JsonResult GetConceptoDescuentos()
        {
            IEnumerable<SelectListItem> listRecord = db.MW_ConceptoDescuentos
                                                        .Where(c => c.BO_Activo == true)
                                                        .AsEnumerable().Select(c => new SelectListItem()
                                                        {
                                                            Text = c.TX_ConceptoDescuento + " Aplica(" + (c.BO_AplicaVehiculo == true ? "Si" : "No") + ")",
                                                            Value = c.ID_ConceptoDescuento.ToString()
                                                        });
