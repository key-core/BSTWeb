...
namespace MedinetWeb.Controllers
{
    [Authorize]
    [SessionExpireFilter]
    public class CadenaFarmaciasController : Controller
    {
        ...
        public ActionResult GetAll([DataSourceRequest] DataSourceRequest request)
        {
            ...
            var lista = _database.CadenaFarmacias.GetAll();  //_database.Registers.GetAll();
        ...
        public ActionResult Add([DataSourceRequest] DataSourceRequest request, MW_CadenaFarmacias record)
        {
            // Test if Register object and modelstate is valid.
            if (record != null && ModelState.IsValid)
            {
                // Add Register to UoW.
                _database.CadenaFarmacias.Add(record);
        ...
        [SessionExpireFilter]
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Update([DataSourceRequest] DataSourceRequest request, MW_CadenaFarmacias record)
        {
            // Test if Register object and modelstate is valid.
            if (record != null && ModelState.IsValid)
            {
                // Update Register to UoW.
                _database.CadenaFarmacias.Update(record);
        ...
        [SessionExpireFilter]
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Delete([DataSourceRequest] DataSourceRequest request, MW_CadenaFarmacias record)
        {
            // Test if Register object and modelstate is valid.           
            if (record != null && ModelState.IsValid)
            {
                // Delete Register from UoW.
                _database.CadenaFarmacias.Delete(record);
        ...
        [Authorize]
        [SessionExpireFilter]
        public JsonResult GetCadenaFarmacias()
        {
            IEnumerable<SelectListItem> listRecord = db.MW_CadenaFarmacias
                                                        .Where(c => c.BO_Activo == true)
                                                        .AsEnumerable().Select(c => new SelectListItem()
                                                        {
                                                            Text = c.TX_Cadena,
                                                            Value = c.ID_Cadena.ToString()
                                                        });
