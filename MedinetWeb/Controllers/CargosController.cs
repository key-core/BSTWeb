...
namespace MedinetWeb.Controllers
{
    ...
    public class CargosController : Controller
    {
        ...
        public ActionResult GetAll([DataSourceRequest] DataSourceRequest request)
        {
            ...
            var lista = _database.Cargos.GetAll();  //_database.Registers.GetAll();
        ...
        public ActionResult Add([DataSourceRequest] DataSourceRequest request, MW_Cargos record)
        {
            // Test if Register object and modelstate is valid.
            if (record != null && ModelState.IsValid)
            {
                // Add Register to UoW.
                _database.Cargos.Add(record);
        ...
        [SessionExpireFilter]
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Update([DataSourceRequest] DataSourceRequest request, MW_Cargos record)
        {
            // Test if Register object and modelstate is valid.
            if (record != null && ModelState.IsValid)
            {
                // Update Register to UoW.
                _database.Cargos.Update(record);
        ...
        [SessionExpireFilter]
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Delete([DataSourceRequest] DataSourceRequest request, MW_Cargos record)
        {
            // Test if Register object and modelstate is valid.           
            if (record != null && ModelState.IsValid)
            {
                // Delete Register from UoW.
                _database.Cargos.Delete(record);
        ...
        {
            IEnumerable<SelectListItem> listRecord = db.MW_Cargos
        ...
        [Authorize]
        [SessionExpireFilter]
        public JsonResult GetCargosVisitantes()
        {
            IEnumerable<SelectListItem> listRecord = db.MW_Cargos
                                                        .Where(c => c.BO_Activo == true && c.BO_Visita == true)
                                                        .AsEnumerable().Select(c => new SelectListItem()
                                                        {
                                                            Text = c.TX_Cargo,
                                                            Value = c.ID_Cargo.ToString()
